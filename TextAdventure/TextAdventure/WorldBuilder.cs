    ...
    public class WorldBuilder
    {
        ...
        public Dictionary<string, Room> CreateRooms()
        {
            ...
            CreateRoom("EAST", "You entered the eastern room. Is that??!! Oh shit, Chuck Norris is here, " +
                               ...
                               "trying to build a rocket with a chewing gum and a pencil. Classic Chuck and Mr.M.",
                items);
        ...
        public void CreateRoom(string name, string roomDesc, List<string> items)
        {
            ...
            for (var i = 0; i < items.Count; i++) room.roomInventory.Add(items[i], itemCollection[items[i]]);
        ...
        public Dictionary<string, Item> CreateItems()
        {
            ...
            CreateItem("POSTER", "A movie poster, Clint Eastwood is the star of the movie.",
                ...
                "1000", true);
            CreateItem("CONTAINER", "A container with a text Prima Fint Snus.",
                "A round container with some text written on it. It's lying upside down. ", "8008", true);
            CreateItem("RAT", "", "A disgusting albino rat with human eyes is dashing around the room. ", "05", false);
            CreateItem("CHUCK", "",
                "You suddenly feel alot better knowing that Chuck is here to save the day. But why is really here?\r\n",
                "1001", false);
            CreateItem("DOOR", "",
                "There's a sturdy looking door here, it seems locked. I can hear birds chirping on the other side of it. *CHIRP*",
                "1230", false);
        ...
        {
            var item = new Item(name, invDesc, roomInvDesc, ID, small);
