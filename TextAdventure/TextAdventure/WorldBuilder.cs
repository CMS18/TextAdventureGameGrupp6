...
namespace TextAdventure
{
    public class WorldBuilder
    {
        ...
        public Dictionary<string, Item> CreateItems()
        {
            ...
            CreateItem("LÖSSNUS", "A container with a text Prima Fint", "A round box of some sort", true);
            CreateItem("RAT", "Oh shit, it was dead", "A disgusting albino rat with human eyes", true);
            CreateLockedItem("DOOR", "", "A sturdy looking door, I can hear birds on the other side of it.", "0001", false, false);
